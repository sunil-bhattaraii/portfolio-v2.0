...
const HeroImage: React.FC = () => {
  return (
    <div className="order-1 lg:order-2 w-1/2 lg:w-full lg:max-w-lg xl:max-w-lg flex justify-center lg:justify-end animate-fade-right [animation-delay:180ms] select-none">
