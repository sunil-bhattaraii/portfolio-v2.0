...
const SocialLinks: React.FC = () => {
  const socials = [
    ...
    { icon: <LeetCodeIcon size={18} />, href: "https://leetcode.com", label: "LeetCode" },
    ...
    { icon: <WhatsAppIcon size={18} />, href: "https://wa.me/9779866325865", label: "WhatsApp" },
  ];

  return (
    <div className="flex items-center justify-center lg:justify-start gap-3 md:gap-4 mb-8 md:mb-10">
